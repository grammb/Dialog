class Macbeth extends Phaser.Scene {
    ...
    create() {
        ...
        this.menteith = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'menteith').setOrigin(0, 1);
        this.siward = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'siward').setOrigin(0, 1);
        this.soldiers = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'soldiers').setOrigin(0, 1);
